...
foreach($resultat->records as $res){ 
    echo '<tr>';
    echo '<td value="'. $res->fields->Nom .'">' . $res->fields->Nom. '</td>';   
    ...
    echo '<td value="'. $res->fields->Type . '">' . $res->fields->Type . '</td>';
    ?>
    <td>
    ...
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Taille"  placeholder="Entrer la Modèle">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Type"  placeholder="Entrer le Type">
...
<script>
    ...
    function getdata(obj, id){
        document.getElementById("Nom").value = (obj.parentNode).parentNode.children.item(0).getAttribute('value') 
