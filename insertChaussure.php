...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js"
    ...
    crossorigin="anonymous"></script>
  <title> Ajouter des Chaussures</title>
</head>
...
<body>
  ...
  <div class="p-3 mb-2 bg-light text-dark">
    ...
    <br><div class="center">
    <h2><span class="badge badge-secondary">Ajouter des Chaussures </span></h2><br>
</div>
...
curl_setopt($curll, CURLOPT_URL, 'https://api.airtable.com/v0/app708JRaOzw9xfPE/Chaussure?view=GridC');
...
foreach ($resultats->records as $record) {
  $varNom = '<p>'.$record->fields->NomCh.'</p>';
...
<div class="row">
  ...
  <div class="col-8">  
    <div class="form-group">
    <div class="form-group">
    <label for="exampleFormControlSelect2">Selectionner une Marque : </label>
