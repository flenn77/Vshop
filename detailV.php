...
curl_setopt($curl, CURLOPT_URL, 'https://api.airtable.com/v0/app708JRaOzw9xfPE/Produits/'.urlencode($_GET["id"]).'');
...
$resultat= json_decode($resultat);
   echo ' <h3> <br><div class="center">Nom Du Produit : <span class="badge badge-secondary">'.$resultat->fields->Nom.'</span></h3>';
   echo ' <h5><br><div class="center">Details du Produit :</h5>
   <p> <div class="center">Type de vetement : '.$resultat->fields->TypeV.'</a><br> 
   Quantité : '.$resultat->fields->Quantite.'<br>
    Prix : '.$resultat->fields->Prix.'€<br> 
    Description : <img src="'.$resultat->fields->Image.'"></img> <br>
    Description : '.$resultat->fields->Description.' 
    </p>  </div> </div></div>';
?>
