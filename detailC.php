...
curl_setopt($curl, CURLOPT_URL, 'https://api.airtable.com/v0/app708JRaOzw9xfPE/chaussure/'.urlencode($_GET["id"]).'');
...
$resultat= json_decode($resultat);
   echo ' <h3> <br><div class="center">Nom De la Chaussure : <span class="badge badge-secondary">'.$resultat->fields->NomCh.'</span></h3>';
   echo ' <h5><br><div class="center">Details de la Chaussure :</h5> 
   <p> <div class="center">Marque : '.$resultat->fields->Marque.'</a><br> 
